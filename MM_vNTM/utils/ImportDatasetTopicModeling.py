...
class ImportDatasetTopicModeling:
    ...
    def get_dataset(self):
        ...
        self.sbert_model_path = datasets_path[self.name_dataset][self.cluster]['sbert_model_path']
        # self.word2vec_path = self.base_path_dir+'GoogleNews-vectors-negative300.bin.gz'
        self.word2vec_path = datasets_path[self.name_dataset][self.cluster]['word2vec_path']
    ...
    #     if  model_name == 'clip':
    #         return "./model/" + "clip-ViT-L-14"
    #     if  model_name == 'clip_32':
    #         return "./model/" + "clip-ViT-B-32"
    #     if model_name == 'sbert':
    #         return "./model/" + "all-mpnet-base-v2"

    def get_sbert_model_path(self):
        return self.sbert_model_path
